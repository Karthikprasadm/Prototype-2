...
const scheduleByDay: Record<ScheduleDayId, BaseScheduleItem[]> = {
  1: [
    ...
    { deptId: "mca", eventName: "IoT Nexus", start: "11:00", end: "17:00", color: "#22d3ee", glowColor: "#67e8f9" },
    {
      ...
      displayName: "Electro-Quiz Circuitrix",
      start: "11:00",
      end: "17:00",
      color: "#3b82f6",
      glowColor: "#60a5fa",
    },
    { deptId: "cse", eventName: "Code Conundrum", start: "11:00", end: "12:30", color: "#0ea5e9", glowColor: "#38bdf8" },
    { deptId: "cse", eventName: "Version Control Wars", start: "14:00", end: "16:00", color: "#0ea5e9", glowColor: "#38bdf8" },
    { deptId: "aiml", eventName: "Reverse Image Prompting", start: "14:00", end: "16:00", color: "#fde047", glowColor: "#fef08a" },
    {
      deptId: "csds",
      eventName: "Data Decoded: The Ultimate Duo Showdown",
      displayName: "Data Decoded",
      start: "14:00",
      end: "17:00",
      color: "#eab308",
      glowColor: "#fbbf24",
  ...
  2: [
    ...
    { deptId: "csds", eventName: "Data Royale: The Last Analyst Standing", start: "09:00", end: "15:30", color: "#facc15", glowColor: "#fde047" },
    { deptId: "mech", eventName: "RC Car Racing", start: "09:00", end: "15:30", color: "#ef4444", glowColor: "#f87171" },
    { deptId: "eee", eventName: "Electraforge – The Grid Survival Challenge", start: "09:00", end: "15:30", color: "#60a5fa", glowColor: "#93c5fd" },
    { deptId: "mca", eventName: "Ideathon Arena", start: "09:00", end: "15:30", color: "#eab308", glowColor: "#fbbf24" },
    { deptId: "aiml", eventName: "Turing Test", start: "10:00", end: "11:00", color: "#fde047", glowColor: "#fef08a" },
    { deptId: "cse", eventName: "Tech Escape Quest", start: "09:00", end: "11:00", color: "#0ea5e9", glowColor: "#38bdf8" },
    ...
    { deptId: "gaming", eventName: "Battlegrounds Mobile India (BGMI)", start: "09:00", end: "15:30", color: "#3b82f6", glowColor: "#60a5fa" },
  ],
}
